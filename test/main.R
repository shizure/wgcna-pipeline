...
###
for(i in (1:length(sft$fitIndices$SFT.R.sq))){
  
  if((sft$fitIndices$SFT.R.sq[i+1] - sft$fitIndices$SFT.R.sq[i]) <= 0.05 &&
     (sft$fitIndices$SFT.R.sq[i+1] - sft$fitIndices$SFT.R.sq[i]) > 0 &&
     (sft$fitIndices$SFT.R.sq[i]) >= 0.8){
